...
import SolarFacUpdate from "./FacUpdate/SolarFacUpdate";
import {Paginations, TableCells, TableHeader, TextWhite} from "../../../../Componet/style-config/light-theme";

function SolarFacAllList(){
    const { facAllList, StationFacList,GetEditFacId} = useContext(SolarPanelContext);
    ...
    return(
        <div>
            <SolarFacUpdate open={open} handleClose={handleClose}/>
            <div className="fa01">
...
export default SolarFacAllList;