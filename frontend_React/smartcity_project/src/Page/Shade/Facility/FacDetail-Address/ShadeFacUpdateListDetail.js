...
function ShadeFacUpdateListDetail(){
    const { FacCheckList, facRecordList} = useContext(ShadeContext);
                        ...
                        <TabContext value={value}>
                            <Box sx={{borderBottom: 1, borderColor: 'divider'}}>
                                <TabList o aria-label="lab API tabs example">
                                    <Tab label="스마트그늘막 시설물 목록" value="1"/>
                                </TabList>
                            </Box>
...
export default ShadeFacUpdateListDetail;