...
function SecurityFacAllListDetail(){
    const { facAllList,SecurityFacList} = useContext(SecurityLightContext);
                        ...
                        <TabContext value={value}>
                            <Box sx={{borderBottom: 1, borderColor: 'divider'}}>
                                <TabList o aria-label="lab API tabs example">
                                    <Tab label="스마트보안등 시설물 목록" value="1"/>
                                </TabList>
                            </Box>
...
export default SecurityFacAllListDetail;