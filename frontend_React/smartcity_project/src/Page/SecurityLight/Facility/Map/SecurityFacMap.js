...
import SecurityFacNew from "../Detail/FacNew/SecurityFacNew";
import arrow from "../../../../img-bg/arrow.png";


function SecurityFacMap() {
    ...
    return (
        <div>
            <SecurityFacNew open={open} handleClose={handleClose}/>
