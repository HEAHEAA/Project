...
import {Style, Stroke, RegularShape, Icon} from "ol/style";
...
// arrow Icon들
import arrowRed from '../../../../img-bg/arrow_red.png';

//light icon
import lightBlue from '../../../../img-bg/light_blue.png';
import lightGreen from '../../../../img-bg/light_green.png';
import lightMint from '../../../../img-bg/light_mint.png';
import lightPurple from '../../../../img-bg/light_purple.png';
import lightRed from '../../../../img-bg/light_red.png';
import lightYellow from '../../../../img-bg/light_yellow.png';
import lightClose from '../../../../img-bg/light_close.png';
...
function ModalMap() {
    ...
    const {mapSize,} = useContext(FacilityContext);
    ...
    return (
        <div>
            {
                mapSize === true ? <div id="mapc" value={mapObject}
                                        style={{
                                            height: '50rem',
                                            width: "100%",
                                            marginLeft: "0%",
                    ...
                    <div id="mapc" value={mapObject}
                         style={{height: '53rem', width: "100%", marginLeft: "0%", marginTop: "-0.5vh"}}></div>
            }
