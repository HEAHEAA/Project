...
function CrossFacUpdate({open, handleClose}) {
    const {CrossUpdateSubmit, code, setCode, name, setName, CrossLng, CrossLat,CrossFacDelete} = useContext(CrossWalkContext);
    //모달스타일
    const style = {
        position: 'absolute',
        top: '50%',
