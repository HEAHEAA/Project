...
import CrossFacUpdate from "./FacUpdate/CrossFacUpdate";
import {TableCells, TableHeader, TextWhite} from "../../../../Componet/style-config/light-theme";

function CrossFacAllList(){
    const { CrossFacList, facAllList,GetEditFacId,} = useContext(CrossWalkContext);
    useEffect(()=>{
        CrossFacList();
    },[]);
    ...
    return(
        <div>
            <CrossFacUpdate open={open} handleClose={handleClose}/>
            <div className="fa01">
...
export default CrossFacAllList;