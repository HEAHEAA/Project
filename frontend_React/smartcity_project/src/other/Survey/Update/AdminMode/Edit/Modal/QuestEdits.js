...
import EditAnswerDetails from "./AnswerDeleteDetail/EditAnswerDetails";

function QuestEdits({EditModalOpen,handleEditClose,seqNum,queNum,mainSeq,QuestListSubmit}){
    ...
    const svAnswerListSubmit = async () => {
        ...
        await fetch(`/api/survey/singleAnswer?sv_main_seqno=${mainSeq}&sv_question_seqno=${queNum}&sv_ans_no=1`, {
            method: "GET",
            headers: {
                "Content-Type": "application/json",
                Authorization: 'Bearer ' + ac,
                ...
                <Box sx={{...style}}>
                    <TabContext value={value}>
                        ...
                        <TabPanel value="1">
                            ...
                            <EditAnswerDetails open={open} handleClose={handleClose} svAnswerEditSubmit={svAnswerEditSubmit}/>
