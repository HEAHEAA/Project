...
function MultiScreenTwo(){
    ...
    useEffect(() => {
        const map = new OlMap({
            ...
            view: new View({
                ...
                zoom: 13,
                center: fromLonLat([127.0067102, 37.2628093]),
            }),
        });
    ...
    return(
        <div>
            <div id="mapa" value={mapObject01} style={{height: "24.5vh", overflow: "hidden"}}></div>
        </div>
    )
}
export default MultiScreenTwo;