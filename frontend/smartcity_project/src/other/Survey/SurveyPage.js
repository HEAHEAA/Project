...
import { BsPersonFillGear,BsClipboard2PlusFill } from "react-icons/bs";

function SurveyPage() { //설문조사 리스트 페이지
            ...
            <Box sx={{width: '100%', typography: 'body1'}} className="survey-page">
                <TabContext value={value}>
                    <div className="media-size">
                        ...
                        }}  color={"secondary"} style={{marginTop: "4vh", float: "right",marginRight: "1vh"}} className="survey-plus-form">
