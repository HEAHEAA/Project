...
import StationFacNew from "../Detail/FacNew/StationFacNew";

function StationFacMap(){
    ...
    return(
        <div>
            <StationFacNew open={open} handleClose={handleClose}/>
