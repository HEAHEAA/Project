...
import ShadeFacUpdate from "./FacUpdate/ShadeFacUpdate";
import {TableCells, TableHeader, TextWhite} from "../../../../Componet/style-config/light-theme";
import Text from "ol/style/Text";

function ShadeFacAllList(){
    const { ShadeFacList, facAllList,GetEditFacId } = useContext(ShadeContext);
    useEffect(()=>{
        ShadeFacList();
    },[]);
    ...
    return(
        <div>
            <ShadeFacUpdate open={open} handleClose={handleClose}/>
            <div className="fa01">
...
export default ShadeFacAllList;