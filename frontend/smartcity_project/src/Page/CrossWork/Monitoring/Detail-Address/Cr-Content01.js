                                        ...
                                        <Table sx={{minWidth: "100%", fontSize: 11}} aria-label="simple table">
                                            <TableHead style={TableHeader}>
                                                <TableRow>
                                                    ...
                                                    <TableCell align={"center"} style={TextWhite}>업로드</TableCell>
                                                </TableRow>
                                            </TableHead>
                                            <TableBody>
                                                {
                                                    seqData.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage)
                                                        .map((arr,inx) => (
                                                            <TableRow key={(rowsPerPage * page) + inx}>
                                                                ...
                                                                <TableCell align={"center"} style={TableCells}>{arr.cross_id}</TableCell>
                                                                ...
                                                                <TableCell align={"center"} style={TableCells}>
                                                                    {arr.time}
                                                                </TableCell>
                                                            </TableRow>
                                                        ))
